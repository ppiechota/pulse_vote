defmodule PulseVoteWeb.UserAuthTest do
  use PulseVoteWeb.ConnCase, async: true

  alias PulseVote.Accounts
  alias PulseVote.Accounts.Scope
  alias PulseVoteWeb.UserAuth

  import PulseVote.AccountsFixtures

  @remember_me_cookie "_pulse_vote_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PulseVoteWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
